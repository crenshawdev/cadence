...
import {
  CURSOR_STATUSES, parseCursor, renderCursor, parseRoadmapPhases, classifyPhaseList,
  CLOSED_CYCLE_NAME, parseRequirements, parseUat, renderUat, uatComplete, atomicWrite,
  parseTaskRecordSnippets, setPhaseBox, setReqStatus, parsePlanRequirements,
  parsePlanFiles, shiftPhaseTokens, findProsePhaseRefs, cutPhaseDetail,
  parseSummarySnippets, parseCaptureSnippets, parseContextDecisions, parseActiveIds,
  classifyActiveSection, isRequirementId, insertReqRows, classifyAcceptanceCriteria,
  UAT_ORIGINS, UAT_SOURCES, UAT_FIELDS_VERSION, phaseRequirements, phaseCriteria,
  planTaskTitles, captureSections, CAPTURE_WALK_SECTIONS, parseArchiveRows,
  appendArchiveRows,
...
import { summarizeReads, joinReads, inDispatchReads } from './lib/read-trace.mjs';
...
import {
  ...
  derivePhases, fail, fireHome, fireIdentity, listPlanFiles, memoryBackend, ok,
  phaseSpellingRefusal, planKey, pluginVersion, read, readJsonPayload, readQueue,
