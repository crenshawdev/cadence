...
- [ ] **Phase 1: The fix pass is a dispatch** - on a blocking gate FAIL the coordinator dispatches a continuation executor under the same plan key and never edits source itself
