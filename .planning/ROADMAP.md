...
- [x] **Phase 3: Pin the stem list and fix the prose** - the `planning-*.test.mjs` stem list gets a census, `CADENCE-CENSUS` gets its prose home in `conventions.md`, and `seam-calls.test.mjs`'s header stops misattributing its own derivation
