...
- [ ] **Phase 1: The guards that remove a protection** - a string `protected_branches` stops resolving to a list that protects nothing, and the bulk-output transport stops letting a concurrent run answer another run's blocking gate
