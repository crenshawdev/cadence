...
- [x] **Phase 2: Both callers on the journal** - `phase-done` and `release-bump` stop claiming an atomicity they do not have, each through the primitive rather than its own approximation of one
