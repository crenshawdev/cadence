...
directories: []
execution: {"schema":1,"suite":"cargo test --workspace --no-fail-fast","tasks":[{"id":"P31-8-T1","verify":["cargo test -p cadence --test phase31_read_layer phase31_planner_round_reports_reads_and_tokens -- --exact"]},{"id":"P31-8-T2","verify":["cargo run -p cadence -- read-instructions"]}]}
---
# Phase 31: The read layer - Plan 8
