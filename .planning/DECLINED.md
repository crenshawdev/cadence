...
- 2026-09-04 github crenshawdev/cadence 6aa875fe57f6d941: [cadence 6aa875fe57f6d941] The `ls agents/*.md | wc -l` verification counts every agent, not the thirty rung files, despite Task 1 explicitly preserving a legal one-off agent outside the rung map.
- 2026-09-05 github crenshawdev/cadence 0eddc09499d95d8d: [cadence 0eddc09499d95d8d] The current milestone traceability table has no ROL-01 row, and none of the five plan tasks adds one.
- 2026-09-05 github crenshawdev/cadence 3e84ffb67e3e87e5: [cadence 3e84ffb67e3e87e5] The schema still exposes `stakes` as a live routing control and promises that an explicit value is a floor, while the resolver now ignores it completely.
- 2026-09-05 github crenshawdev/cadence 75b8d5884b3032a6: [cadence 75b8d5884b3032a6] The dotted-path walker cannot distinguish a literal property containing a dot from a nested path, so `unset` can delete a different key than the caller requested.
- 2026-09-05 github crenshawdev/cadence 21f390ed276a1f7f: [cadence 21f390ed276a1f7f] Parsing the entire schema-blind layer into JavaScript numbers and serializing it after a removal can corrupt unrelated values that were not requested for deletion.
