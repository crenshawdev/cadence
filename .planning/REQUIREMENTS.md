...
the tracker picks #95, #96, #101, #106-#109. Two themes: work that started
...
coordinator itself, and the one dispatch bought without a sizing question).
...
|-------------|-------|--------|
| TRC-01 | Phase 1 | Pending |
| SIZ-01 | Phase 1 | Pending |
