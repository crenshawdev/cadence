...
That is five commands out of twenty-seven. [`/cad-help`](./skills/cad-help/SKILL.md) lists all shipped commands by cluster inside a session, or shows one command and its compiled description.
