...
#[test]
fn record_id_binds_root_phase_and_roadmap_bytes_and_the_shape_is_exact() {
...
#[test]
fn contribute_appends_under_its_own_namespace_and_applicability_yields_to_native_authority() {
