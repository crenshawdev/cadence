...
mod tests {
    ...
    fn canonical_public_fixtures_cover_every_arm_and_success_variant() {
        ...
        let fixtures = [
            ...
            (
                r##"{"dispatch_id":"d1","expected_execution_version":1,"identities":{"context":{"kind":"phase-context","phase":6},"dispatch":{"id":"d1","kind":"dispatch"},"plan":{"kind":"phase-plan","phase":6,"plan":1}},"outcome":"dispatch","prompt_digest":"d08d660b7de4e2314def9d953b46d4fec2db3acbfe7344cda4ede7faacc5e177","route":null,"status":"ok"}"##,
                "51a7c0f23e68f0d4ccef17ff33edfff4d325229bd84d4332fabc551b63c7ed50",
            ),
        ];
